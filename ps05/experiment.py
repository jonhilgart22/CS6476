...
def main():
    ...
    # 1b
    kernel_dims = None  # TODO: Define a the kernel dimensions (tuple)
    alpha = None  # TODO: Set a float value for alpha
    ...
    # 1c
    threshold = None  # TODO: define a threshold value
    radius = None  # TODO: define a radius value
    ...
    # 2a
    size = None  # TODO: Define a size value
